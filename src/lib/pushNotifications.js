...
export const readMyPushState = async () => {
  ...
  const endpoint =
    currentSubscription?.endpoint || null;
  ...
  return {
    ...
    permission:
      typeof Notification !== "undefined"
        ...
        : "unsupported",
    browserSubscribed: Boolean(currentSubscription),
    endpoint,
    serverState: data,
  };
};
...
export const enablePushNotifications = async () => {
  ...
  const authKey = arrayBufferToBase64Url(
  ...
  const auditId = createAuditId("REGISTER");
...
export const disablePushNotifications = async () => {
  ...
  const auditId = createAuditId("DISABLE");
