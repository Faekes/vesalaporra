  ...
  return (
    <div className="closing-recap-overlay" role="dialog" aria-modal="true">
      <style>{`
        ...
        .closing-recap-stage{position:relative;width:min(420px,calc(100vw - 28px));height:min(746px,calc(100vh - 28px));aspect-ratio:9/16;overflow:hidden;isolation:isolate;color:#fff;border:1px solid rgba(247,215,92,.44);border-radius:28px;background:radial-gradient(circle at 50% 18%,rgba(247,215,92,.16),transparent 30%),radial-gradient(circle at 12% 82%,rgba(36,82,199,.3),transparent 38%),radial-gradient(circle at 92% 68%,rgba(165,0,68,.3),transparent 36%),linear-gradient(160deg,#171b2e 0%,#080b17 54%,#03050c 100%);box-shadow:0 35px 100px rgba(0,0,0,.76),0 0 55px rgba(247,215,92,.13);font-family:Inter,system-ui,sans-serif}
